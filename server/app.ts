...
// This module only registers the Express app and its routes. The actual
// serving entry points live elsewhere:
//   - server.ts       local/Node hosting (Vite dev middleware or static dist)
//   - api/index.ts    Vercel serverless function (see vercel.json)
export { app };
